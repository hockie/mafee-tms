...
// Create page object
$expenses_view = new cexpenses_view();
$Page =& $expenses_view;

// Page init
$expenses_view->Page_Init();

// Page main
$expenses_view->Page_Main();
?>
...
// Create page object
var expenses_view = new ew_Page("expenses_view");

// page properties
expenses_view.PageID = "view"; // page ID
expenses_view.FormID = "fexpensesview"; // form ID
var EW_PAGE_ID = expenses_view.PageID; // for backward compatibility

// extend page with Form_CustomValidate function
expenses_view.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
expenses_view.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
	ew_ClickAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
expenses_view.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
expenses_view.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<?php } ?>
<p><span class="phpmaker"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $expenses->TableCaption() ?>
<br><br>
<?php if ($expenses->Export == "") { ?>
<a href="<?php echo $expenses_view->ListUrl ?>"><?php echo $Language->Phrase("BackToList") ?></a>&nbsp;
<?php if ($Security->CanAdd()) { ?>
<a href="<?php echo $expenses_view->AddUrl ?>"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>&nbsp;
<?php } ?>
<?php if ($Security->CanEdit()) { ?>
<a href="<?php echo $expenses_view->EditUrl ?>"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>&nbsp;
<?php } ?>
<?php if ($Security->CanDelete()) { ?>
<a href="<?php echo $expenses_view->DeleteUrl ?>"><?php echo $Language->Phrase("ViewPageDeleteLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
</span></p>
<?php
...
<div<?php echo $expenses->id->ViewAttributes() ?>><?php echo $expenses->id->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->Date_Created->ViewAttributes() ?>><?php echo $expenses->Date_Created->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->expense_date->ViewAttributes() ?>><?php echo $expenses->expense_date->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->expense_category_id->ViewAttributes() ?>><?php echo $expenses->expense_category_id->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->Reference_No->ViewAttributes() ?>><?php echo $expenses->Reference_No->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->Booking_ID->ViewAttributes() ?>><?php echo $expenses->Booking_ID->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->Description->ViewAttributes() ?>><?php echo $expenses->Description->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->Amount->ViewAttributes() ?>><?php echo $expenses->Amount->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->Vat->ViewAttributes() ?>><?php echo $expenses->Vat->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->Total_Sales->ViewAttributes() ?>><?php echo $expenses->Total_Sales->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->Wtax->ViewAttributes() ?>><?php echo $expenses->Wtax->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->Total_Amount_Due->ViewAttributes() ?>><?php echo $expenses->Total_Amount_Due->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<a href="<?php echo $expenses->File_Upload->HrefValue ?>"><?php echo $expenses->File_Upload->ViewValue ?></a>
<?php } elseif (!in_array($expenses->CurrentAction, array("I", "edit", "gridedit"))) { ?>	
&nbsp;
<?php } ?>
<?php } else { ?>
<?php if (!empty($expenses->File_Upload->Upload->DbValue)) { ?>
<?php echo $expenses->File_Upload->ViewValue ?>
<?php } elseif (!in_array($expenses->CurrentAction, array("I", "edit", "gridedit"))) { ?>	
&nbsp;
<?php } ?>
<?php } ?>
...
<div<?php echo $expenses->Expenses_Type_ID->ViewAttributes() ?>><?php echo $expenses->Expenses_Type_ID->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->Add_To_Billing->ViewAttributes() ?>><?php echo $expenses->Add_To_Billing->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->approver->ViewAttributes() ?>><?php echo $expenses->approver->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->employee_id->ViewAttributes() ?>><?php echo $expenses->employee_id->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->modified->ViewAttributes() ?>><?php echo $expenses->modified->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->user_id->ViewAttributes() ?>><?php echo $expenses->user_id->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->payment_mode->ViewAttributes() ?>><?php echo $expenses->payment_mode->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->status->ViewAttributes() ?>><?php echo $expenses->status->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $expenses->Remarks->ViewAttributes() ?>><?php echo $expenses->Remarks->ViewValue ?></div></td>
	</tr>
<?php } ?>
</table>
</div>
...
class cexpenses_view {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$this->arRecKey["id"] = $expenses->id->QueryStringValue;
			} else {
				$sReturnUrl = "expenseslist.php"; // Return to list
			}

			// Get action
			$expenses->CurrentAction = "I"; // Display form
			switch ($expenses->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						$this->setMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "expenseslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "expenseslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
			$this->Page_Terminate($sReturnUrl);

		// Render row
		$expenses->RowType = EW_ROWTYPE_VIEW;
		$this->RenderRow();
	}
	...
	function RenderRow() {
		...
		// Initialize URLs
		$this->ExportPrintUrl = $this->PageUrl() . "export=print&" . "id=" . urlencode($expenses->id->CurrentValue);
		$this->ExportHtmlUrl = $this->PageUrl() . "export=html&" . "id=" . urlencode($expenses->id->CurrentValue);
		$this->ExportExcelUrl = $this->PageUrl() . "export=excel&" . "id=" . urlencode($expenses->id->CurrentValue);
		$this->ExportWordUrl = $this->PageUrl() . "export=word&" . "id=" . urlencode($expenses->id->CurrentValue);
		$this->ExportXmlUrl = $this->PageUrl() . "export=xml&" . "id=" . urlencode($expenses->id->CurrentValue);
		$this->ExportCsvUrl = $this->PageUrl() . "export=csv&" . "id=" . urlencode($expenses->id->CurrentValue);
		$this->AddUrl = $expenses->AddUrl();
		$this->EditUrl = $expenses->EditUrl();
		$this->CopyUrl = $expenses->CopyUrl();
		$this->DeleteUrl = $expenses->DeleteUrl();
		$this->ListUrl = $expenses->ListUrl();

...
<div<?php echo $users->UserLevel->ViewAttributes() ?>><?php echo $users->UserLevel->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $users->employee_ID->ViewAttributes() ?>><?php echo $users->employee_ID->ViewValue ?></div></td>
	</tr>
<?php } ?>
</table>
</div>
...
class cusers_view {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$this->arRecKey["id"] = $users->id->QueryStringValue;
			} else {
	...
	function RenderRow() {
		...
		// Initialize URLs
		$this->ExportPrintUrl = $this->PageUrl() . "export=print&" . "id=" . urlencode($users->id->CurrentValue);
		$this->ExportHtmlUrl = $this->PageUrl() . "export=html&" . "id=" . urlencode($users->id->CurrentValue);
		$this->ExportExcelUrl = $this->PageUrl() . "export=excel&" . "id=" . urlencode($users->id->CurrentValue);
		$this->ExportWordUrl = $this->PageUrl() . "export=word&" . "id=" . urlencode($users->id->CurrentValue);
		$this->ExportXmlUrl = $this->PageUrl() . "export=xml&" . "id=" . urlencode($users->id->CurrentValue);
		$this->ExportCsvUrl = $this->PageUrl() . "export=csv&" . "id=" . urlencode($users->id->CurrentValue);

...
// Create page object
$employees_delete = new cemployees_delete();
...
// Create page object
var employees_delete = new ew_Page("employees_delete");

// page properties
employees_delete.PageID = "delete"; // page ID
employees_delete.FormID = "femployeesdelete"; // form ID
var EW_PAGE_ID = employees_delete.PageID; // for backward compatibility

// extend page with Form_CustomValidate function
employees_delete.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
employees_delete.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
	ew_ClickAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
employees_delete.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
employees_delete.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
if ($rs = $employees_delete->LoadRecordset())
	$employees_deletelTotalRecs = $rs->RecordCount(); // Get record count
if ($employees_deletelTotalRecs <= 0) { // No record found, exit
	if ($rs)
		$rs->Close();
	$employees_delete->Page_Terminate("employeeslist.php"); // Return to list
}
?>
<p><span class="phpmaker"><?php echo $Language->Phrase("Delete") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $employees->TableCaption() ?><br><br>
...
<?php foreach ($employees_delete->arRecKeys as $key) { ?>
...
<?php echo $employees->TableCustomInnerHtml ?>
	...
	<tr class="ewTableHeader">
		<td valign="top"><?php echo $employees->id->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->EmployeeID->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->FirstName->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->MiddleName->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->LastName->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->Username->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->EmailAddress->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->Address->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->MobileNumber->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->SubconID->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->manager->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->Designation->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->EmpRateId->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->DateHired->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->DateTerminated->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->EmpStatusId->FldCaption() ?></td>
		<td valign="top"><?php echo $employees->Password->FldCaption() ?></td>
	</tr>
	</thead>
	<tbody>
<?php
$employees_delete->lRecCnt = 0;
$i = 0;
while (!$rs->EOF) {
	$employees_delete->lRecCnt++;

	// Set row properties
	$employees->CssClass = "";
	$employees->CssStyle = "";
	$employees->RowAttrs = array();
	$employees->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$employees_delete->LoadRowValues($rs);
...
<div<?php echo $employees->id->ViewAttributes() ?>><?php echo $employees->id->ListViewValue() ?></div></td>
		<td<?php echo $employees->EmployeeID->CellAttributes() ?>>
<div<?php echo $employees->EmployeeID->ViewAttributes() ?>><?php echo $employees->EmployeeID->ListViewValue() ?></div></td>
		<td<?php echo $employees->FirstName->CellAttributes() ?>>
<div<?php echo $employees->FirstName->ViewAttributes() ?>><?php echo $employees->FirstName->ListViewValue() ?></div></td>
		<td<?php echo $employees->MiddleName->CellAttributes() ?>>
<div<?php echo $employees->MiddleName->ViewAttributes() ?>><?php echo $employees->MiddleName->ListViewValue() ?></div></td>
		<td<?php echo $employees->LastName->CellAttributes() ?>>
<div<?php echo $employees->LastName->ViewAttributes() ?>><?php echo $employees->LastName->ListViewValue() ?></div></td>
		<td<?php echo $employees->Username->CellAttributes() ?>>
<div<?php echo $employees->Username->ViewAttributes() ?>><?php echo $employees->Username->ListViewValue() ?></div></td>
		<td<?php echo $employees->EmailAddress->CellAttributes() ?>>
<div<?php echo $employees->EmailAddress->ViewAttributes() ?>><?php echo $employees->EmailAddress->ListViewValue() ?></div></td>
		<td<?php echo $employees->Address->CellAttributes() ?>>
<div<?php echo $employees->Address->ViewAttributes() ?>><?php echo $employees->Address->ListViewValue() ?></div></td>
		<td<?php echo $employees->MobileNumber->CellAttributes() ?>>
<div<?php echo $employees->MobileNumber->ViewAttributes() ?>><?php echo $employees->MobileNumber->ListViewValue() ?></div></td>
		<td<?php echo $employees->SubconID->CellAttributes() ?>>
<div<?php echo $employees->SubconID->ViewAttributes() ?>><?php echo $employees->SubconID->ListViewValue() ?></div></td>
		<td<?php echo $employees->manager->CellAttributes() ?>>
<div<?php echo $employees->manager->ViewAttributes() ?>><?php echo $employees->manager->ListViewValue() ?></div></td>
		<td<?php echo $employees->Designation->CellAttributes() ?>>
<div<?php echo $employees->Designation->ViewAttributes() ?>><?php echo $employees->Designation->ListViewValue() ?></div></td>
		<td<?php echo $employees->EmpRateId->CellAttributes() ?>>
<div<?php echo $employees->EmpRateId->ViewAttributes() ?>><?php echo $employees->EmpRateId->ListViewValue() ?></div></td>
		<td<?php echo $employees->DateHired->CellAttributes() ?>>
<div<?php echo $employees->DateHired->ViewAttributes() ?>><?php echo $employees->DateHired->ListViewValue() ?></div></td>
		<td<?php echo $employees->DateTerminated->CellAttributes() ?>>
<div<?php echo $employees->DateTerminated->ViewAttributes() ?>><?php echo $employees->DateTerminated->ListViewValue() ?></div></td>
		<td<?php echo $employees->EmpStatusId->CellAttributes() ?>>
<div<?php echo $employees->EmpStatusId->ViewAttributes() ?>><?php echo $employees->EmpStatusId->ListViewValue() ?></div></td>
		<td<?php echo $employees->Password->CellAttributes() ?>>
<div<?php echo $employees->Password->ViewAttributes() ?>><?php echo $employees->Password->ListViewValue() ?></div></td>
	</tr>
<?php
	$rs->MoveNext();
}
...
class cemployees_delete {
	...
	function Page_Main() {
		...
		if (@$_GET["id"] <> "") {
			...
			if (!is_numeric($employees->id->QueryStringValue))
				$this->Page_Terminate("employeeslist.php"); // Prevent SQL injection, exit
			$sKey .= $employees->id->QueryStringValue;
		} else {
			$bSingleDelete = FALSE;
		}
		if ($bSingleDelete) {
		...
		if ($nKeySelected <= 0)
			$this->Page_Terminate("employeeslist.php"); // No key specified, return to list
		...
		// Get action
		if (@$_POST["a_delete"] <> "") {
			$employees->CurrentAction = $_POST["a_delete"];
		} else {
			$employees->CurrentAction = "I"; // Display record
		}
		switch ($employees->CurrentAction) {
			case "D": // Delete
				$employees->SendEmail = TRUE; // Send email on delete success
				if ($this->DeleteRows()) { // delete rows
					$this->setMessage($Language->Phrase("DeleteSuccess")); // Set up success message
					$this->Page_Terminate($employees->getReturnUrl()); // Return to caller
				}
		}
	}
	...
	function DeleteRows() {
		...
		$DeleteRows = TRUE;
		$sWrkFilter = $employees->CurrentFilter;

		// Set up filter (SQL WHERE clause) and get return SQL
		// SQL constructor in employees class, employeesinfo.php

		$employees->CurrentFilter = $sWrkFilter;
		$sSql = $employees->SQL();
		...
		if ($DeleteRows) {
			foreach ($rsold as $row) {
				$DeleteRows = $employees->Row_Deleting($row);
				if (!$DeleteRows) break;
			}
		}
		if ($DeleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$sThisKey .= $row['id'];
				$conn->raiseErrorFn = 'ew_ErrorFn';
				$DeleteRows = $conn->Execute($employees->DeleteSQL($row)); // Delete
				$conn->raiseErrorFn = '';
				if ($DeleteRows === FALSE)
					break;
				if ($sKey <> "") $sKey .= ", ";

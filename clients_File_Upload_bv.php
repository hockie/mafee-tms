...
// Create page object
$clients_File_Upload_blobview = new cclients_File_Upload_blobview();
$Page =& $clients_File_Upload_blobview;

// Page init
$clients_File_Upload_blobview->Page_Init();

// Page main
$clients_File_Upload_blobview->Page_Main();
?>
<?php
$clients_File_Upload_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cclients_File_Upload_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'clients_File_Upload_blobview';
	...
	//
	function cclients_File_Upload_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('clients');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('clients', 'x_File_Upload');

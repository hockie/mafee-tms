...
// Create page object
$company_File_Upload_blobview = new ccompany_File_Upload_blobview();
$Page =& $company_File_Upload_blobview;

// Page init
$company_File_Upload_blobview->Page_Init();

// Page main
$company_File_Upload_blobview->Page_Main();
?>
<?php
$company_File_Upload_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class ccompany_File_Upload_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'company_File_Upload_blobview';
	...
	//
	function ccompany_File_Upload_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('company');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('company', 'x_File_Upload');

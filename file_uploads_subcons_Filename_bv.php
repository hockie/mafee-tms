...
// Create page object
$file_uploads_subcons_Filename_blobview = new cfile_uploads_subcons_Filename_blobview();
$Page =& $file_uploads_subcons_Filename_blobview;

// Page init
$file_uploads_subcons_Filename_blobview->Page_Init();

// Page main
$file_uploads_subcons_Filename_blobview->Page_Main();
?>
<?php
$file_uploads_subcons_Filename_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cfile_uploads_subcons_Filename_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'file_uploads_subcons_Filename_blobview';
	...
	//
	function cfile_uploads_subcons_Filename_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('file_uploads_subcons');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('file_uploads_subcons', 'x_Filename');

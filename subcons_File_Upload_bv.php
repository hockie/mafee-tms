...
// Create page object
$subcons_File_Upload_blobview = new csubcons_File_Upload_blobview();
$Page =& $subcons_File_Upload_blobview;

// Page init
$subcons_File_Upload_blobview->Page_Init();

// Page main
$subcons_File_Upload_blobview->Page_Main();
?>
<?php
$subcons_File_Upload_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class csubcons_File_Upload_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'subcons_File_Upload_blobview';
	...
	//
	function csubcons_File_Upload_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('subcons');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('subcons', 'x_File_Upload');

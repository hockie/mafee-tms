...
$client_payment_period = NULL;

//
// Table class for client_payment_period
//
class cclient_payment_period {
	var $TableVar = 'client_payment_period';
	...
	//
	function cclient_payment_period() {
		global $Language;

		// id
		$this->id = new cField('client_payment_period', 'client_payment_period', 'x_id', 'id', '`id`', 3, -1, FALSE, '`id`', FALSE);
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// client_id
		$this->client_id = new cField('client_payment_period', 'client_payment_period', 'x_client_id', 'client_id', '`client_id`', 3, -1, FALSE, '`client_id`', FALSE);
		$this->client_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['client_id'] =& $this->client_id;

		// payment_period
		$this->payment_period = new cField('client_payment_period', 'client_payment_period', 'x_payment_period', 'payment_period', '`payment_period`', 3, -1, FALSE, '`payment_period`', FALSE);
		$this->payment_period->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['payment_period'] =& $this->payment_period;

		// Remarks
		$this->Remarks = new cField('client_payment_period', 'client_payment_period', 'x_Remarks', 'Remarks', '`Remarks`', 201, -1, FALSE, '`Remarks`', FALSE);
	...
	function HighlightName() {
		return "client_payment_period_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `client_payment_period` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `client_payment_period` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `client_payment_period` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "client_payment_periodlist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("client_payment_periodview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "client_payment_periodadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("client_payment_periodedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("client_payment_periodadd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("client_payment_perioddelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=client_payment_period" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;

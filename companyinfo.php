...
class ccompany {
	...
	function ccompany() {
		...
		// id
		$this->id = new cField('company', 'company', 'x_id', 'id', '`id`', 3, -1, FALSE, '`id`', FALSE);
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// Company_Name
		$this->Company_Name = new cField('company', 'company', 'x_Company_Name', 'Company_Name', '`Company_Name`', 200, -1, FALSE, '`Company_Name`', FALSE);
		$this->fields['Company_Name'] =& $this->Company_Name;

		// Main_Address
		$this->Main_Address = new cField('company', 'company', 'x_Main_Address', 'Main_Address', '`Main_Address`', 201, -1, FALSE, '`Main_Address`', FALSE);
		$this->fields['Main_Address'] =& $this->Main_Address;

		// Contact_No
		$this->Contact_No = new cField('company', 'company', 'x_Contact_No', 'Contact_No', '`Contact_No`', 200, -1, FALSE, '`Contact_No`', FALSE);
		$this->fields['Contact_No'] =& $this->Contact_No;

		// Email_Address
		$this->Email_Address = new cField('company', 'company', 'x_Email_Address', 'Email_Address', '`Email_Address`', 200, -1, FALSE, '`Email_Address`', FALSE);
		$this->fields['Email_Address'] =& $this->Email_Address;

		// Website
		$this->Website = new cField('company', 'company', 'x_Website', 'Website', '`Website`', 200, -1, FALSE, '`Website`', FALSE);
		$this->fields['Website'] =& $this->Website;

		// TIN_No
		$this->TIN_No = new cField('company', 'company', 'x_TIN_No', 'TIN_No', '`TIN_No`', 200, -1, FALSE, '`TIN_No`', FALSE);
		$this->fields['TIN_No'] =& $this->TIN_No;

		// File_Upload
		$this->File_Upload = new cField('company', 'company', 'x_File_Upload', 'File_Upload', '`File_Upload`', 200, -1, TRUE, '`File_Upload`', FALSE);
		$this->File_Upload->UploadPath = EW_UPLOAD_DEST_PATH;
		$this->fields['File_Upload'] =& $this->File_Upload;

		// Remarks
		$this->Remarks = new cField('company', 'company', 'x_Remarks', 'Remarks', '`Remarks`', 201, -1, FALSE, '`Remarks`', FALSE);
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `company` ($names) VALUES ($values)";
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("companyview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "companyadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("companyedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("companyadd.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=company" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function LoadListRowValues(&$rs) {
		...
		$this->Main_Address->setDbValue($rs->fields('Main_Address'));
   ...
   // Common render codes
		...
		// Company_Name
		$this->Company_Name->CellCssStyle = ""; $this->Company_Name->CellCssClass = "";
		$this->Company_Name->CellAttrs = array(); $this->Company_Name->ViewAttrs = array(); $this->Company_Name->EditAttrs = array();
		...
		$this->Company_Name->CssStyle = "";
		$this->Company_Name->CssClass = "";
		...
		if (!ew_Empty($this->File_Upload->Upload->DbValue)) {
			...
			if ($this->Export <> "") $company->File_Upload->HrefValue = ew_ConvertFullUrl($this->File_Upload->HrefValue);
		} else {

...
// Create page object
$expenses_File_Upload_blobview = new cexpenses_File_Upload_blobview();
$Page =& $expenses_File_Upload_blobview;

// Page init
$expenses_File_Upload_blobview->Page_Init();

// Page main
$expenses_File_Upload_blobview->Page_Main();
?>
<?php
$expenses_File_Upload_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cexpenses_File_Upload_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'expenses_File_Upload_blobview';
	...
	//
	function cexpenses_File_Upload_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('expenses');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('expenses', 'x_File_Upload');

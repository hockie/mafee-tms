...
// Create page object
$truck_drivers_File_Upload_blobview = new ctruck_drivers_File_Upload_blobview();
$Page =& $truck_drivers_File_Upload_blobview;

// Page init
$truck_drivers_File_Upload_blobview->Page_Init();

// Page main
$truck_drivers_File_Upload_blobview->Page_Main();
?>
<?php
$truck_drivers_File_Upload_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class ctruck_drivers_File_Upload_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'truck_drivers_File_Upload_blobview';
	...
	//
	function ctruck_drivers_File_Upload_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('truck_drivers');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('truck_drivers', 'x_File_Upload');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				if (trim(strval($rs->fields('File_Upload'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $rs->fields('File_Upload'));
				}
				$objBinary->Value = $rs->fields('File_Upload');

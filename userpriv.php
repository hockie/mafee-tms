...
<a href="userlevelslist.php"><?php echo $Language->Phrase("BackToList") ?></a></span></p>
<p><span class="phpmaker"><?php echo $Language->Phrase("UserLevel") ?><?php echo $Security->GetUserLevelName($userlevels->userlevelid->CurrentValue) ?>(<?php echo $userlevels->userlevelid->CurrentValue ?>)</span></p>
<?php
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();

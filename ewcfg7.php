...
define("EW_DEFAULT_DATE_FORMAT", "mm/dd/yyyy", TRUE); // Default date format
define("EW_DEFAULT_DATE_FORMAT_ID", "6", TRUE); // Default date format
define("EW_DATE_SEPARATOR", "/", TRUE); // Date separator
define("EW_PROJECT_NAME", "MTMS", TRUE); // Project name
define("EW_RANDOM_KEY", 'u2DLYo0Y0mwbQu9G', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "MTMS.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", "mafee_tms", TRUE);
*/
// Database connection info

define("EW_CONN_HOST", "localhost", TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", "favexsiz_mafee_user", TRUE);
define("EW_CONN_PASS", "8Yvs1Qj5kzol", TRUE);
define("EW_CONN_DB", "favexsiz_mafee_portal", TRUE);
...
$EW_USER_LEVEL_TABLE_NAME[] = 'bookings';
$EW_USER_LEVEL_TABLE_VAR[] = 'bookings';
$EW_USER_LEVEL_TABLE_NAME[] = 'clients';
$EW_USER_LEVEL_TABLE_VAR[] = 'clients';
$EW_USER_LEVEL_TABLE_NAME[] = 'consignees';
$EW_USER_LEVEL_TABLE_VAR[] = 'consignees';
$EW_USER_LEVEL_TABLE_NAME[] = 'subcons';
$EW_USER_LEVEL_TABLE_VAR[] = 'subcons';
$EW_USER_LEVEL_TABLE_NAME[] = 'file_uploads';
$EW_USER_LEVEL_TABLE_VAR[] = 'file_uploads';
$EW_USER_LEVEL_TABLE_NAME[] = 'rates';
$EW_USER_LEVEL_TABLE_VAR[] = 'rates';
$EW_USER_LEVEL_TABLE_NAME[] = 'truck_drivers';
$EW_USER_LEVEL_TABLE_VAR[] = 'truck_drivers';
$EW_USER_LEVEL_TABLE_NAME[] = 'helpers';
$EW_USER_LEVEL_TABLE_VAR[] = 'helpers';
$EW_USER_LEVEL_TABLE_NAME[] = 'origins';
$EW_USER_LEVEL_TABLE_VAR[] = 'origins';
$EW_USER_LEVEL_TABLE_NAME[] = 'areas';
$EW_USER_LEVEL_TABLE_VAR[] = 'areas';
$EW_USER_LEVEL_TABLE_NAME[] = 'destinations';
$EW_USER_LEVEL_TABLE_VAR[] = 'destinations';
$EW_USER_LEVEL_TABLE_NAME[] = 'statuses';
$EW_USER_LEVEL_TABLE_VAR[] = 'statuses';
$EW_USER_LEVEL_TABLE_NAME[] = 'trucks';
$EW_USER_LEVEL_TABLE_VAR[] = 'trucks';
$EW_USER_LEVEL_TABLE_NAME[] = 'billing_types';
$EW_USER_LEVEL_TABLE_VAR[] = 'billing_types';
$EW_USER_LEVEL_TABLE_NAME[] = 'expenses';
$EW_USER_LEVEL_TABLE_VAR[] = 'expenses';
$EW_USER_LEVEL_TABLE_NAME[] = 'doc_types';
$EW_USER_LEVEL_TABLE_VAR[] = 'doc_types';
$EW_USER_LEVEL_TABLE_NAME[] = 'file_types';
$EW_USER_LEVEL_TABLE_VAR[] = 'file_types';
$EW_USER_LEVEL_TABLE_NAME[] = 'truck_types';
$EW_USER_LEVEL_TABLE_VAR[] = 'truck_types';
$EW_USER_LEVEL_TABLE_NAME[] = 'units';
$EW_USER_LEVEL_TABLE_VAR[] = 'units';
$EW_USER_LEVEL_TABLE_NAME[] = 'employees';
$EW_USER_LEVEL_TABLE_VAR[] = 'employees';
$EW_USER_LEVEL_TABLE_NAME[] = 'users';
$EW_USER_LEVEL_TABLE_VAR[] = 'users';
$EW_USER_LEVEL_TABLE_NAME[] = 'expenses_types';
$EW_USER_LEVEL_TABLE_VAR[] = 'expenses_types';
$EW_USER_LEVEL_TABLE_NAME[] = 'booking_helpers';
$EW_USER_LEVEL_TABLE_VAR[] = 'booking_helpers';
$EW_USER_LEVEL_TABLE_NAME[] = 'accounts_receivable';
$EW_USER_LEVEL_TABLE_VAR[] = 'accounts_receivable';
$EW_USER_LEVEL_TABLE_NAME[] = 'sales';
$EW_USER_LEVEL_TABLE_VAR[] = 'sales';
$EW_USER_LEVEL_TABLE_NAME[] = 'audittrail';
$EW_USER_LEVEL_TABLE_VAR[] = 'audittrail';
$EW_USER_LEVEL_TABLE_NAME[] = 'company';
$EW_USER_LEVEL_TABLE_VAR[] = 'company';
$EW_USER_LEVEL_TABLE_NAME[] = 'billinglist';
$EW_USER_LEVEL_TABLE_VAR[] = 'billinglist';
$EW_USER_LEVEL_TABLE_NAME[] = 'client_payment_period';
$EW_USER_LEVEL_TABLE_VAR[] = 'client_payment_period';
$EW_USER_LEVEL_TABLE_NAME[] = 'file_uploads_subcons';
$EW_USER_LEVEL_TABLE_VAR[] = 'file_uploads_subcons';
$EW_USER_LEVEL_TABLE_NAME[] = 'file_uploads_trucks';
$EW_USER_LEVEL_TABLE_VAR[] = 'file_uploads_trucks';
$EW_USER_LEVEL_TABLE_NAME[] = 'invoices';
$EW_USER_LEVEL_TABLE_VAR[] = 'invoices';
$EW_USER_LEVEL_TABLE_NAME[] = 'invoice_items';
$EW_USER_LEVEL_TABLE_VAR[] = 'invoice_items';
$EW_USER_LEVEL_TABLE_NAME[] = 'banks_accounts';
$EW_USER_LEVEL_TABLE_VAR[] = 'banks_accounts';
$EW_USER_LEVEL_TABLE_NAME[] = 'account_payments';
$EW_USER_LEVEL_TABLE_VAR[] = 'account_payments';
$EW_USER_LEVEL_TABLE_NAME[] = 'customer_invoices';
$EW_USER_LEVEL_TABLE_VAR[] = 'customer_invoices';
$EW_USER_LEVEL_TABLE_NAME[] = 'journal_accounts';
$EW_USER_LEVEL_TABLE_VAR[] = 'journal_accounts';
$EW_USER_LEVEL_TABLE_NAME[] = 'journal_types';
$EW_USER_LEVEL_TABLE_VAR[] = 'journal_types';
$EW_USER_LEVEL_TABLE_NAME[] = 'account_payment_methods';
$EW_USER_LEVEL_TABLE_VAR[] = 'account_payment_methods';
$EW_USER_LEVEL_TABLE_NAME[] = 'all_file_uploads';
$EW_USER_LEVEL_TABLE_VAR[] = 'all_file_uploads';
$EW_USER_LEVEL_TABLE_NAME[] = 'expense_categories';
$EW_USER_LEVEL_TABLE_VAR[] = 'expense_categories';
$EW_USER_LEVEL_TABLE_NAME[] = 'vendors';
$EW_USER_LEVEL_TABLE_VAR[] = 'vendors';
$EW_USER_LEVEL_TABLE_NAME[] = 'vendor_bill';
$EW_USER_LEVEL_TABLE_VAR[] = 'vendor_bill';
$EW_USER_LEVEL_TABLE_NAME[] = 'vendor_bill_items';
$EW_USER_LEVEL_TABLE_VAR[] = 'vendor_bill_items';
for ($i = 0; $i < 44; $i++)
...
define("EW_USE_SUBQUERY_FOR_MASTER_USER_ID", TRUE, TRUE);
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "jpg,jpeg,png,doc,pdf,docx,zip,rar", TRUE); // Allowed file extensions
define("EW_IMAGE_ALLOWED_FILE_EXT", "gif,jpg,png,bmp", TRUE); // Allowed file extensions for images
define("EW_MAX_FILE_SIZE", 50000000, TRUE); // Max file size

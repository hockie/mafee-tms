...
// Create page object
$all_file_uploads_File_Name_blobview = new call_file_uploads_File_Name_blobview();
$Page =& $all_file_uploads_File_Name_blobview;

// Page init
$all_file_uploads_File_Name_blobview->Page_Init();

// Page main
$all_file_uploads_File_Name_blobview->Page_Main();
?>
<?php
$all_file_uploads_File_Name_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class call_file_uploads_File_Name_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'all_file_uploads_File_Name_blobview';
	...
	//
	function call_file_uploads_File_Name_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('all_file_uploads');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('all_file_uploads', 'x_File_Name');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				if (trim(strval($rs->fields('File_Name'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $rs->fields('File_Name'));
				}
				$objBinary->Value = $rs->fields('File_Name');

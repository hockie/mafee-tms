...
class ccustomers {
	...
	function ccustomers() {
		...
		// id
		$this->id = new cField('customers', 'customers', 'x_id', 'id', '`id`', 3, -1, FALSE, '`id`', FALSE);
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// client_id
		$this->client_id = new cField('customers', 'customers', 'x_client_id', 'client_id', '`client_id`', 3, -1, FALSE, '`client_id`', FALSE);
		$this->client_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['client_id'] =& $this->client_id;

		// Customer_No
		$this->Customer_No = new cField('customers', 'customers', 'x_Customer_No', 'Customer_No', '`Customer_No`', 200, -1, FALSE, '`Customer_No`', FALSE);
		$this->fields['Customer_No'] =& $this->Customer_No;

		// Customer_Name
		$this->Customer_Name = new cField('customers', 'customers', 'x_Customer_Name', 'Customer_Name', '`Customer_Name`', 200, -1, FALSE, '`Customer_Name`', FALSE);
		$this->fields['Customer_Name'] =& $this->Customer_Name;

		// Address
		$this->Address = new cField('customers', 'customers', 'x_Address', 'Address', '`Address`', 200, -1, FALSE, '`Address`', FALSE);
		$this->fields['Address'] =& $this->Address;

		// Contact_Person
		$this->Contact_Person = new cField('customers', 'customers', 'x_Contact_Person', 'Contact_Person', '`Contact_Person`', 200, -1, FALSE, '`Contact_Person`', FALSE);
		$this->fields['Contact_Person'] =& $this->Contact_Person;

		// Contact_No
		$this->Contact_No = new cField('customers', 'customers', 'x_Contact_No', 'Contact_No', '`Contact_No`', 200, -1, FALSE, '`Contact_No`', FALSE);
		$this->fields['Contact_No'] =& $this->Contact_No;

		// Remarks
		$this->Remarks = new cField('customers', 'customers', 'x_Remarks', 'Remarks', '`Remarks`', 201, -1, FALSE, '`Remarks`', FALSE);
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `customers` ($names) VALUES ($values)";
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("customersview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "customersadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("customersedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("customersadd.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=customers" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;

...
// Create page object
$trucks_File_Upload_blobview = new ctrucks_File_Upload_blobview();
$Page =& $trucks_File_Upload_blobview;

// Page init
$trucks_File_Upload_blobview->Page_Init();

// Page main
$trucks_File_Upload_blobview->Page_Main();
?>
<?php
$trucks_File_Upload_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class ctrucks_File_Upload_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'trucks_File_Upload_blobview';
	...
	//
	function ctrucks_File_Upload_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('trucks');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('trucks', 'x_File_Upload');
